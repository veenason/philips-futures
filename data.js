  ...
  themes: {
    ...
    "invisible-wellness": {
      ...
      interfaceExamples: [
        ...
        { shift: "Evidence shift", title: "Scanning becomes ambient", summary: "Whole-body sensing moves into quiet moments of rest; progress, purpose and consent remain visible without turning the experience into a dashboard.", implication: "Treat scanning as a calm temporal interface: show the active zone, the remaining duration and the route back to evidence or human review.", tokens: ["Ambient", "Legible", "Reversible"], demo: "why-now-pause-loop", demoAlt: "A person resting in an MRI while a restrained cobalt scanning plane moves across the body" },
